...
class QuestionsViewController: UIViewController {
    ...
    @IBOutlet var rangedSlider: UISlider! {
        didSet {
            ...
            answersChoosen.append(currentAnswers[Int(answerCount)])
            //nextQuestion()
        }
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let tabBarController = segue.destination as! ResultsViewController
        tabBarController.textOfLabel = answersChoosen
